 ...
 */
public class BBNCreation2 {


    private static String orginalBBNNFileName = "FinalBBNFinal.dne";
    private static String newBBNFileName = "FinalBBN6.dne";
    ...
    public static void main(String[] args)
    {
        try {
            ...
            // add two new nodes for expected price of ric and maize
            ...
            ExpectedPriceOfMaize.visual().setStyle("LabeledBox");
            ExpectedPriceOfRice.visual().setStyle("LabeledBox");

            distanceToBigMarket.setStateNames("LessThan15Km, Between15And30Km, Above30Km");

...
public class TestAccuracy {
    ...
    public static void main(String[] args) throws NeticaException {
        ...
        try
        {
            ...
            myNet = new Net(new Streamer("BBNs/FinalBBN6.dne"));
		...
		System.out.println("**************From arrayList TAN+TK****************");
		for (Double double1 : errorRateList) {
			System.out.printf("%.2f", double1);
			System.out.println();
		}

        /*System.out.println("The mean error from the five fold cross validation is :" + mean(errorRate));
